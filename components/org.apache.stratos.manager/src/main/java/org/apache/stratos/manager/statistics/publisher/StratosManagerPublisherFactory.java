...
/**
 * Creating ApplictionSignUpDataPublisher.
 */
public class StratosManagerPublisherFactory {
    /**
     * Create application sign up data publisher
     *
     * @return ApplicationSignUpDataPublisher
     */
    public static ApplicationSignUpDataPublisher createApplicationSignUpDataPublisher() {
        ...
        if (type == StatisticsPublisherType.WSO2DAS) {
            return DASApplicationSignUpDataPublisher.getInstance();
        } else if (type == StatisticsPublisherType.JDBC) {
            return JDBCApplicationSignUpDataPublisher.getInstance();
        } else {
