...
var MIN_SCALE = 'Minimum instance check';
var RIF_SCALE = 'In-flight request prediction';
var MC_SCALE = 'Memory consumption prediction';
var LA_SCALE = 'Load average prediction';
...
function makeRows(data) {
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        var row = columns.map(function (column) {
            if (column.COLUMN_NAME == 'ScalingReason') {
                if (record[column.COLUMN_NAME] == 'MIN') {
                    return MIN_SCALE;
                } else if (record[column.COLUMN_NAME] == 'RIF') {
                    return RIF_SCALE;
                } else if (record[column.COLUMN_NAME] == 'MC') {
                    return MC_SCALE;
                } else if (record[column.COLUMN_NAME] == 'LA') {
                    return LA_SCALE;
                }
